...
_OFFICIAL_REPO_CANONICAL = "github.com/nikolaygusev-astra/autolycus"
...
def format_banner_version_label() -> str:
    ...
    base = f"Autolycus Agent v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    try:
        ...
        _hero = _bskin.banner_hero if hasattr(_bskin, 'banner_hero') and _bskin.banner_hero else AUTOLYCUS_CADUCEUS
    except Exception:
        _bskin = None
        _hero = AUTOLYCUS_CADUCEUS
    left_lines = ["", _hero, ""]
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]☿ Autolycus[/]")
    ...
    if term_width >= 95:
        _logo = _bskin.banner_logo if _bskin and hasattr(_bskin, 'banner_logo') and _bskin.banner_logo else AUTOLYCUS_AGENT_LOGO
        console.print(_logo)
        console.print()
