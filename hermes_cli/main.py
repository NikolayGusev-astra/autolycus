...
Usage:
    ...
    autolycus gateway status      # Show gateway status
    autolycus gateway install     # Install gateway service
    autolycus gateway uninstall   # Uninstall gateway service
    autolycus setup               # Interactive setup wizard
